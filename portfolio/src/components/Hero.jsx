...
const Hero = () => {
  ...
  return (
    <>
      <div>
        <div className=" hidden  md:flex md:flex-row md:h-[350px] lg:h-[730px] bg-[#C4C4C4] md:mb-2 lg:mb-4">
          <div className="w-1/2 h-full bg-gradient-to-tl from-[#C4C4C4] to-[#C4C4C4]">
            <div className="flex flex-col justify-center items-center">
              <img
                src="/Images/logo 1.png"
                className=" md:w-[36px] md:h-[50px] lg:w-[60px] lg:h-[180px] lg:pt-6 md:pt-2 md:pb-4 lg:pb-28"
                alt=""
              />
              <p className="text-[#000000] font-bold md:text-xl lg:text-2xl mb-24">
                Hi, I am
              </p>
              <p className="text-[#000000] font-bold md:text-2xl lg:text-[60px] md:mb-2 lg:mb-8">
                Tomasz Gajda
              </p>
              <p className="text-[#909090] font-extrabold md:text-xl lg:text-2xl md:mb-4 lg:mb-12">
        ...
        <div className="hidden md:block md:bg-[#1d1d1d]  md:h-[150px] lg:h-[180px]">
          <h1 className="text-white font-bold md:text-xl lg:text-3xl md:pt-1 lg:pt-3 md:ml-2 md:mb-2 lg:ml-8 lg:mb-4">
            IT BERRIES
          </h1>
          <p className="text-[#1b4263] md:max-w-[1100px] lg:max-w-[1000px] pl-10 md:text-sm lg:text-base">
